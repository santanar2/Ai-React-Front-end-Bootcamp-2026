...
const baseClasses=
'flex cursor-ponter items-center justify-center font-midum text-sm gap-2 px-4 py-3 transition-opacity hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-80 '
